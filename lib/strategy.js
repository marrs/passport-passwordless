...
PasswordlessStrategy.prototype.authenticate = function(req, options) {
  ...
  if (token && uid) {
    ...
    return this.error('Could not authenticate! Please specify a user id for the specified delivery or specify a valid token and uid!');
  }
};

//Get a parameter value from an req.
